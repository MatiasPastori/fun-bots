...
Language:add(code, "Meters bots in Air vehicles / Mobile Artillery / AA start shooting at players", "")
Language:add(code, "Max Shoot-Distance No Anti Air", "")
Language:add(code, "Meters bots in a land vehicle ( Tanks, LAV, Humvees, etc) starts shooting at players", "")
Language:add(code, "Max Shoot-Distance for Gunship", "")
Language:add(code, "Max meters distance for bots in a Gunship to start shooting at players", "")
